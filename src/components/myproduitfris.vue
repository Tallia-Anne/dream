<template>
  <section class="our-publication">
    <mynav />
    <div class="header">
      <img class="container-img" src="../assets/841.jpg" alt="mon image" />
    </div>
    <div class="container">
      <div class="section-header">
        <h2>Produits pour les cheveux frisés</h2>
      </div>
      <div class="section-paragraphe">
        <p>
          les cheveux frisés ont tendance à devenir secs car le sébum que
          produit la racine a du mal à circuler jusqu’aux pointes. Surtout au
          naturel, les cheveux frisés ont besoin d’une hydratation maintenue
          dans la fibre capillaire. Plus fragiles et cassants, ils sont parfois
          difficiles à coiffer et demandent des soins particuliers pour garder
          leur brillance et leur douceur.
        </p>
      </div>
