<template>
  <section class="our-publication">
    ...
    <div class="header">
      <img
        class="container-img"
        src="../assets/5f49226ec7d59 (1).jpg"
        alt="mon image"
      />
    </div>
    <div class="container">
      <div class="section-header">
        <h2>Produits pour les cheveux crépus</h2>
      </div>
      <div class="section-paragraphe">
        <p>
          Cheveux crépus est un cheveu particulier qui nécessite des soins
          adaptés pour pouvoir pousser forts et en bonne santé
        </p>
      </div>
...
export default {
  ...
  created() {
    this.axios
      .get("http://localhost:3000/produit/limit/12")
      .then((res) => {
