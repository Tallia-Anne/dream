<template>
  <section class="our-publication">
    ...
    <div>
      ...
      >
        <b-carousel-slide
          img-src="https://www.marlobeauty.com/images//graphics/Pro2Pro%20Graphics/Pro2Pro%20Article%20Images/pure_honey_header.jpg"
        ></b-carousel-slide>
        <b-carousel-slide
          img-src="https://i2.wp.com/www.hypehair.com/wp-content/uploads/2018/03/creme-of-nature-pure-honey-collection-ig.png?w=1080&ssl=1"
        ></b-carousel-slide>
        <b-carousel-slide
          img-src="https://dev.rodpub.com/images/164/101_main.jpg"
        ></b-carousel-slide>
        <b-carousel-slide
          img-src="https://missbeautybunny.com/wp-content/uploads/2018/03/CON-Honey-1-930x620.jpg"
        ></b-carousel-slide>
      </b-carousel>
    </div>
    <div class="container">
      <div class="section-header">
        <h2>Crème of nature pure honey</h2>
      </div>
      <div class="row">
