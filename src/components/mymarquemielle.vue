<template>
  <section class="our-publication">
    ...
    <div>
      ...
      >
        <b-carousel-slide
          img-src="https://www.sanicosmeticos.com/content/images/uploaded/Mielle%20Organics.jpg"
        ></b-carousel-slide>
        <b-carousel-slide
          img-src="https://www.sanicosmeticos.com/content/images/thumbs/5ee25929b6ef1d31140e9d50_mielle-organics_450.jpeg"
        ></b-carousel-slide>
      </b-carousel>
    </div>
    <div class="container">
      <div class="section-header">
        <h2>Mielle organics</h2>
      </div>
      <div class="row">
