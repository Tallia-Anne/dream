<template>
  <section class="our-publication">
    <mynav />
    <div class="header">
      <img class="container-img" src="../assets/178.jpg" alt="mon image" />
    </div>
    <div class="container">
      <div class="section-header">
        <h2>Produits pour les cheveux bouclés</h2>
      </div>
      <div class="section-paragraphe">
        <p>
          les cheveux bouclés, ça en jette. Quand ils sont brillants et
          maîtrisés, tu peux vraiment te la péter
        </p>
      </div>
