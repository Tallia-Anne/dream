<template>
  <section class="our-publication">
    ...
    <div>
      ...
      >
        <b-carousel-slide
          img-src="https://www.fibrany.com/wp-content/uploads/2020/08/kairly-paris-fibrany-box-cheveux-boucle-frise-crepu.jpg.webp"
        ></b-carousel-slide>
        <b-carousel-slide
          img-src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSzGlYQ_tVvNDuV0pag7zMnb3RYTKJnBECP5Q&usqp=CAU"
        ></b-carousel-slide>
      </b-carousel>
    </div>
    <div class="container">
